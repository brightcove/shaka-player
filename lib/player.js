...
shaka.Player.prototype.createDrmEngine = function() {
  ...
  var playerInterface = {
    ...
    onEvent: this.onEvent_.bind(this),
    onSendLicenseAttempt: this.onSendLicenseAttempt_.bind(this)
  };
 ...
 * @private
 */
shaka.Player.prototype.onSendLicenseAttempt_ = function() {
  var event = new shaka.util.FakeEvent('licenserequestattempted');
  this.dispatchEvent(event);
};
