 ...
 * @param {function()} onSendLicenseAttempt
 * @struct
 * @implements {shaka.util.IDestroyable}
 */
shaka.media.DrmEngine = function(
    networkingEngine, onError, onKeyStatus, onExpirationUpdated, onSendLicenseAttempt) {
  ...
  /** @private {?function()} */
  this.onSendLicenseAttempt_ = onSendLicenseAttempt;
...
shaka.media.DrmEngine.prototype.sendLicenseRequest_ = function(event) {
  ...
  this.networkingEngine_.request(requestType, request)
      .then(function(response) {
        ...
        if (this.onSendLicenseAttempt_) {
          this.onSendLicenseAttempt_();
        }
