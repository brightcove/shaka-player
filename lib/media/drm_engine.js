 ...
 * @property {function()} onSendLicenseAttempt
 *   Called when a license request is triggered.
 */
...
shaka.media.DrmEngine.prototype.sendLicenseRequest_ = function(event) {
  ...
  this.playerInterface_.netEngine.request(requestType, request)
      .then(function(response) {
        ...
        this.playerInterface_.onSendLicenseAttempt();
